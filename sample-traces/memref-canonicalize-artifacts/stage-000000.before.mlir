...
module {
  ...
  func.func @expand_shape_identity_fold(%arg0: memref<5x4xi8>) -> memref<5x4xi8> {
    %expand_shape = memref.expand_shape %arg0 [[0], [1]] output_shape [5, 4] : memref<5x4xi8> into memref<5x4xi8>
    return %expand_shape : memref<5x4xi8>
  }
  func.func @collapse_expand_rank0_cancel(%arg0: memref<1x1xi8>) -> memref<1x1xi8> {
    %collapse_shape = memref.collapse_shape %arg0 [] : memref<1x1xi8> into memref<i8>
    %expand_shape = memref.expand_shape %collapse_shape [] output_shape [1, 1] : memref<i8> into memref<1x1xi8>
    return %expand_shape : memref<1x1xi8>
  }
  func.func @subview_of_size_memcast(%arg0: memref<4x6x16x32xi8>) -> memref<16x32xi8, strided<[32, 1], offset: 512>> {
    %cast = memref.cast %arg0 : memref<4x6x16x32xi8> to memref<?x?x16x32xi8>
    %subview = memref.subview %cast[0, 1, 0, 0] [1, 1, 16, 32] [1, 1, 1, 1] : memref<?x?x16x32xi8> to memref<16x32xi8, strided<[32, 1], offset: 512>>
  ...
  func.func @subview_of_strides_memcast(%arg0: memref<1x1x?xf32, strided<[35, 7, 1], offset: ?>>) -> memref<1x4xf32, strided<[?, ?], offset: ?>> {
    %cast = memref.cast %arg0 : memref<1x1x?xf32, strided<[35, 7, 1], offset: ?>> to memref<1x1x?xf32, strided<[?, ?, ?], offset: ?>>
    %subview = memref.subview %cast[0, 0, 0] [1, 1, 4] [1, 1, 1] : memref<1x1x?xf32, strided<[?, ?, ?], offset: ?>> to memref<1x4xf32, strided<[?, ?], offset: ?>>
    return %subview : memref<1x4xf32, strided<[?, ?], offset: ?>>
  }
  func.func @subview_of_static_full_size(%arg0: memref<4x6x16x32xi8>) -> memref<4x6x16x32xi8> {
    %subview = memref.subview %arg0[0, 0, 0, 0] [4, 6, 16, 32] [1, 1, 1, 1] : memref<4x6x16x32xi8> to memref<4x6x16x32xi8>
    return %subview : memref<4x6x16x32xi8>
  }
  ...
  func.func @subview_canonicalize(%arg0: memref<?x?x?xf32>, %arg1: index, %arg2: index) -> memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>> {
    ...
    %subview = memref.subview %arg0[%c0, %arg1, %c1] [%c4, %c1, %arg2] [%c1, %c1, %c1] : memref<?x?x?xf32> to memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>
  ...
  func.func @rank_reducing_subview_canonicalize(%arg0: memref<?x?x?xf32>, %arg1: index, %arg2: index) -> memref<?x?xf32, strided<[?, ?], offset: ?>> {
    ...
    %c1 = arith.constant 1 : index
    %c4 = arith.constant 4 : index
    %subview = memref.subview %arg0[%c0, %arg1, %c1] [%c4, 1, %arg2] [%c1, %c1, %c1] : memref<?x?x?xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
  ...
  func.func @multiple_reducing_dims(%arg0: memref<1x384x384xf32>, %arg1: index, %arg2: index, %arg3: index) -> memref<?xf32, strided<[1], offset: ?>> {
    %c1 = arith.constant 1 : index
    %subview = memref.subview %arg0[0, %arg1, %arg2] [1, %c1, %arg3] [1, 1, 1] : memref<1x384x384xf32> to memref<?x?xf32, strided<[384, 1], offset: ?>>
    %subview_0 = memref.subview %subview[0, 0] [1, %arg3] [1, 1] : memref<?x?xf32, strided<[384, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
  ...
  func.func @multiple_reducing_dims_dynamic(%arg0: memref<?x?x?xf32>, %arg1: index, %arg2: index, %arg3: index) -> memref<?xf32, strided<[1], offset: ?>> {
    %c1 = arith.constant 1 : index
    %subview = memref.subview %arg0[0, %arg1, %arg2] [1, %c1, %arg3] [1, 1, 1] : memref<?x?x?xf32> to memref<?x?xf32, strided<[?, 1], offset: ?>>
    %subview_0 = memref.subview %subview[0, 0] [1, %arg3] [1, 1] : memref<?x?xf32, strided<[?, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
    return %subview_0 : memref<?xf32, strided<[1], offset: ?>>
  }
  func.func @multiple_reducing_dims_all_dynamic(%arg0: memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>, %arg1: index, %arg2: index, %arg3: index) -> memref<?xf32, strided<[?], offset: ?>> {
    %c1 = arith.constant 1 : index
    %subview = memref.subview %arg0[0, %arg1, %arg2] [1, %c1, %arg3] [1, 1, 1] : memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>> to memref<?x?xf32, strided<[?, ?], offset: ?>>
    %subview_0 = memref.subview %subview[0, 0] [1, %arg3] [1, 1] : memref<?x?xf32, strided<[?, ?], offset: ?>> to memref<?xf32, strided<[?], offset: ?>>
  ...
  func.func @subview_negative_stride1(%arg0: memref<?xf32>) -> memref<?xf32, strided<[?], offset: ?>> {
    ...
    %subview = memref.subview %arg0[%0] [%dim] [%c-1] : memref<?xf32> to memref<?xf32, strided<[?], offset: ?>>
    return %subview : memref<?xf32, strided<[?], offset: ?>>
  }
  func.func @subview_negative_stride2(%arg0: memref<7xf32>) -> memref<?xf32, strided<[?], offset: ?>> {
    %c0 = arith.constant 0 : index
    %c-1 = arith.constant -1 : index
    %dim = memref.dim %arg0, %c0 : memref<7xf32>
    %0 = arith.addi %dim, %c-1 : index
    %subview = memref.subview %arg0[%0] [%dim] [%c-1] : memref<7xf32> to memref<?xf32, strided<[?], offset: ?>>
    return %subview : memref<?xf32, strided<[?], offset: ?>>
  }
  func.func @dim_of_sized_view(%arg0: memref<?xi8>, %arg1: index) -> index {
    ...
    %dim = memref.dim %reinterpret_cast, %c0 : memref<?xi8>
    return %dim : index
  }
  ...
  func.func @dim_of_alloca(%arg0: index) -> index {
    %alloca = memref.alloca(%arg0) : memref<?xindex>
    %c0 = arith.constant 0 : index
    %dim = memref.dim %alloca, %c0 : memref<?xindex>
    return %dim : index
  }
  ...
  func.func @alloc_const_fold() -> memref<?xf32> {
    %c4 = arith.constant 4 : index
    %alloc = memref.alloc(%c4) : memref<?xf32>
  ...
  func.func @alloc_const_fold_with_symbols2() -> memref<?xi32, strided<[?], offset: ?>> {
    %c1 = arith.constant 1 : index
    %alloc = memref.alloc(%c1)[%c1, %c1] : memref<?xi32, strided<[?], offset: ?>>
    return %alloc : memref<?xi32, strided<[?], offset: ?>>
  }
  ...
  func.func @compose_collapse_of_collapse_zero_dim(%arg0: memref<1x1x1xf32>) -> memref<f32> {
    %collapse_shape = memref.collapse_shape %arg0 [[0, 1, 2]] : memref<1x1x1xf32> into memref<1xf32>
    %collapse_shape_0 = memref.collapse_shape %collapse_shape [] : memref<1xf32> into memref<f32>
    return %collapse_shape_0 : memref<f32>
  }
  ...
  func.func @compose_expand_of_expand(%arg0: memref<?x?xf32>, %arg1: index, %arg2: index, %arg3: index, %arg4: index) -> memref<?x6x4x5x?xf32> {
    %expand_shape = memref.expand_shape %arg0 [[0, 1], [2]] output_shape [%arg1, 4, %arg2] : memref<?x?xf32> into memref<?x4x?xf32>
    %expand_shape_0 = memref.expand_shape %expand_shape [[0, 1], [2], [3, 4]] output_shape [%arg3, 6, 4, 5, %arg4] : memref<?x4x?xf32> into memref<?x6x4x5x?xf32>
    return %expand_shape_0 : memref<?x6x4x5x?xf32>
  }
  func.func @compose_expand_of_expand_of_zero_dim(%arg0: memref<f32>) -> memref<1x1x1xf32> {
    %expand_shape = memref.expand_shape %arg0 [] output_shape [1] : memref<f32> into memref<1xf32>
    %expand_shape_0 = memref.expand_shape %expand_shape [[0, 1, 2]] output_shape [1, 1, 1] : memref<1xf32> into memref<1x1x1xf32>
    return %expand_shape_0 : memref<1x1x1xf32>
  }
  func.func @fold_collapse_of_expand(%arg0: memref<12x4xf32>) -> memref<12x4xf32> {
    %expand_shape = memref.expand_shape %arg0 [[0, 1], [2]] output_shape [3, 4, 4] : memref<12x4xf32> into memref<3x4x4xf32>
    %collapse_shape = memref.collapse_shape %expand_shape [[0, 1], [2]] : memref<3x4x4xf32> into memref<12x4xf32>
    return %collapse_shape : memref<12x4xf32>
  }
  func.func @fold_collapse_collapse_of_expand(%arg0: memref<?x?xf32>, %arg1: index, %arg2: index) -> memref<?x?xf32> {
    %expand_shape = memref.expand_shape %arg0 [[0, 1], [2]] output_shape [%arg1, 4, %arg2] : memref<?x?xf32> into memref<?x4x?xf32>
    %collapse_shape = memref.collapse_shape %expand_shape [[0, 1], [2]] : memref<?x4x?xf32> into memref<?x?xf32>
  ...
  func.func @reduced_memref(%arg0: memref<2x5x7x1xf32>, %arg1: index) -> memref<1x4x1xf32, strided<[35, 7, 1], offset: ?>> {
    ...
    %c1 = arith.constant 1 : index
    %subview = memref.subview %arg0[%arg1, %arg1, %arg1, 0] [%c1, %c4, %c1, 1] [1, 1, 1, 1] : memref<2x5x7x1xf32> to memref<?x?x?xf32, strided<[35, 7, 1], offset: ?>>
    %cast = memref.cast %subview : memref<?x?x?xf32, strided<[35, 7, 1], offset: ?>> to memref<1x4x1xf32, strided<[35, 7, 1], offset: ?>>
    return %cast : memref<1x4x1xf32, strided<[35, 7, 1], offset: ?>>
  }
  ...
  func.func @fold_no_op_subview(%arg0: memref<20x42xf32>) -> memref<20x42xf32, strided<[42, 1]>> {
    %subview = memref.subview %arg0[0, 0] [20, 42] [1, 1] : memref<20x42xf32> to memref<20x42xf32, strided<[42, 1]>>
    return %subview : memref<20x42xf32, strided<[42, 1]>>
  }
  ...
  func.func @copy_of_cast(%arg0: memref<?xf32>, %arg1: memref<*xf32>) {
    %cast = memref.cast %arg0 : memref<?xf32> to memref<?xf32, strided<[?], offset: ?>>
    %cast_0 = memref.cast %arg1 : memref<*xf32> to memref<?xf32, strided<[?], offset: ?>>
    memref.copy %cast, %cast_0 : memref<?xf32, strided<[?], offset: ?>> to memref<?xf32, strided<[?], offset: ?>>
    return
  }
  ...
  func.func @empty_copy(%arg0: memref<0x10xf32>, %arg1: memref<?x10xf32>) {
    memref.copy %arg0, %arg1 : memref<0x10xf32> to memref<?x10xf32>
    memref.copy %arg1, %arg0 : memref<?x10xf32> to memref<0x10xf32>
    return
  }
  ...
  func.func @reinterpret_noop(%arg0: memref<2x3x4xf32>) -> memref<2x3x4xf32> {
    %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [0], sizes: [2, 3, 4], strides: [12, 4, 1] : memref<2x3x4xf32> to memref<2x3x4xf32>
    return %reinterpret_cast : memref<2x3x4xf32>
  }
  func.func @reinterpret_of_reinterpret(%arg0: memref<?xi8>, %arg1: index, %arg2: index) -> memref<?xi8> {
    %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [0], sizes: [%arg1], strides: [1] : memref<?xi8> to memref<?xi8>
    %reinterpret_cast_0 = memref.reinterpret_cast %reinterpret_cast to offset: [0], sizes: [%arg2], strides: [1] : memref<?xi8> to memref<?xi8>
    return %reinterpret_cast_0 : memref<?xi8>
  }
  func.func @reinterpret_of_cast(%arg0: memref<?xi8>, %arg1: index) -> memref<?xi8> {
    %cast = memref.cast %arg0 : memref<?xi8> to memref<5xi8>
    %reinterpret_cast = memref.reinterpret_cast %cast to offset: [0], sizes: [%arg1], strides: [1] : memref<5xi8> to memref<?xi8>
    return %reinterpret_cast : memref<?xi8>
  }
  func.func @reinterpret_of_subview(%arg0: memref<?xi8>, %arg1: index, %arg2: index) -> memref<?xi8> {
    %subview = memref.subview %arg0[0] [%arg1] [1] : memref<?xi8> to memref<?xi8>
    %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [%arg2], strides: [1] : memref<?xi8> to memref<?xi8>
    return %reinterpret_cast : memref<?xi8>
  }
  ...
  func.func @reinterpret_of_extract_strided_metadata_w_constants(%arg0: memref<8x2xf32>) -> memref<?x?xf32, strided<[?, ?], offset: ?>> {
    ...
    %reinterpret_cast = memref.reinterpret_cast %base_buffer to offset: [0], sizes: [%c8, 2], strides: [2, %strides#1] : memref<f32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
    return %reinterpret_cast : memref<?x?xf32, strided<[?, ?], offset: ?>>
  }
  ...
  func.func @reinterpret_of_extract_strided_metadata_w_different_stride(%arg0: memref<8x2xf32>) -> memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>> {
    %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %arg0 : memref<8x2xf32> -> memref<f32>, index, index, index, index, index
    %reinterpret_cast = memref.reinterpret_cast %base_buffer to offset: [%offset], sizes: [4, 2, 2], strides: [1, 1, %strides#1] : memref<f32> to memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>
  ...
  func.func @reinterpret_of_extract_strided_metadata_w_different_offset(%arg0: memref<8x2xf32>) -> memref<?x?xf32, strided<[?, ?], offset: ?>> {
    %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %arg0 : memref<8x2xf32> -> memref<f32>, index, index, index, index, index
    %reinterpret_cast = memref.reinterpret_cast %base_buffer to offset: [1], sizes: [%sizes#0, %sizes#1], strides: [%strides#0, %strides#1] : memref<f32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
    return %reinterpret_cast : memref<?x?xf32, strided<[?, ?], offset: ?>>
  }
  func.func @canonicalize_rank_reduced_subview(%arg0: memref<8x?xf32>, %arg1: index) -> memref<?xf32, strided<[?], offset: ?>> {
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %subview = memref.subview %arg0[%c0, %c0] [1, %arg1] [%c1, %c1] : memref<8x?xf32> to memref<?xf32, strided<[?], offset: ?>>
    return %subview : memref<?xf32, strided<[?], offset: ?>>
  }
  ...
  func.func @collapse_expand_fold_to_cast(%arg0: memref<?xf32, strided<[1]>, 3>, %arg1: index) -> memref<?xf32, 3> {
    %expand_shape = memref.expand_shape %arg0 [[0, 1]] output_shape [1, %arg1] : memref<?xf32, strided<[1]>, 3> into memref<1x?xf32, 3>
    %collapse_shape = memref.collapse_shape %expand_shape [[0, 1]] : memref<1x?xf32, 3> into memref<?xf32, 3>
    return %collapse_shape : memref<?xf32, 3>
  }
  func.func @fold_trivial_subviews(%arg0: memref<?xf32, strided<[?], offset: ?>>, %arg1: index) -> memref<?xf32, strided<[?], offset: ?>> {
    ...
    %subview_0 = memref.subview %subview[0] [%arg1] [1] : memref<?xf32, strided<[?], offset: ?>> to memref<?xf32, strided<[?], offset: ?>>
    return %subview_0 : memref<?xf32, strided<[?], offset: ?>>
  }
  ...
  func.func @subview_rank_reduction(%arg0: memref<1x384x384xf32>, %arg1: index) -> memref<?x?xf32, strided<[384, 1], offset: ?>> {
    %c1 = arith.constant 1 : index
    %subview = memref.subview %arg0[0, %arg1, %arg1] [1, %c1, %arg1] [1, 1, 1] : memref<1x384x384xf32> to memref<?x?xf32, strided<[384, 1], offset: ?>>
    return %subview : memref<?x?xf32, strided<[384, 1], offset: ?>>
  }
  ...
  func.func @fold_double_transpose2(%arg0: memref<1x2x3x4x5xf32>) -> memref<5x3x2x4x1xf32, strided<[1, 20, 60, 5, 120]>> {
    %transpose = memref.transpose %arg0 (d0, d1, d2, d3, d4) -> (d0, d1, d4, d3, d2) : memref<1x2x3x4x5xf32> to memref<1x2x5x4x3xf32, strided<[120, 60, 1, 5, 20]>>
    %transpose_0 = memref.transpose %transpose (d0, d1, d2, d3, d4) -> (d2, d4, d1, d3, d0) : memref<1x2x5x4x3xf32, strided<[120, 60, 1, 5, 20]>> to memref<5x3x2x4x1xf32, strided<[1, 20, 60, 5, 120]>>
    return %transpose_0 : memref<5x3x2x4x1xf32, strided<[1, 20, 60, 5, 120]>>
  }
  func.func @fold_identity_transpose(%arg0: memref<1x2x3x4x5xf32>) -> memref<1x2x3x4x5xf32> {
    %transpose = memref.transpose %arg0 (d0, d1, d2, d3, d4) -> (d1, d0, d4, d3, d2) : memref<1x2x3x4x5xf32> to memref<2x1x5x4x3xf32, strided<[60, 120, 1, 5, 20]>>
    %transpose_0 = memref.transpose %transpose (d0, d1, d2, d3, d4) -> (d1, d0, d4, d3, d2) : memref<2x1x5x4x3xf32, strided<[60, 120, 1, 5, 20]>> to memref<1x2x3x4x5xf32>
    return %transpose_0 : memref<1x2x3x4x5xf32>
  }
